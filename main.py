...
if __name__ == "__main__":
    """When running locally, we can use print statements to capture 
    logs / info. As a result, we will disable python logging to run. 
    This will keep the output cleaner.
    """
